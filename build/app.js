...
/***/ "./js/conditionalContent sync recursive ^\\.\\/.*\\.js$":
/*!*************************************************!*\
  !*** ./js/conditionalContent sync ^\.\/.*\.js$ ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./conditionalContent.js": "./js/conditionalContent/conditionalContent.js",
	"./content.js": "./js/conditionalContent/content.js"
};
...
webpackContext.id = "./js/conditionalContent sync recursive ^\\.\\/.*\\.js$";

/***/ }),

/***/ "./js/conditionalContent/conditionalContent.js":
/*!*****************************************************!*\
  !*** ./js/conditionalContent/conditionalContent.js ***!
  \*****************************************************/
/*! no static exports found */
...
var originParam = urlParam('origin');
var langParam = urlParam('locale');
  ...
  contentBlocks.forEach(function (contentBlock) {
    ...
    if (contentBlock.indexOf('image') !== -1) {
      if ($el.hasClass('b-lazy')) {
        ...
        var imageProperty = selectedOrigin[contentBlock][pixelDensity]; //  set image background in css 

        var imgSrc = 'url(' + imageProperty + ')';
...
var init = function init(dataSource) {
  data = __webpack_require__("./js/conditionalContent sync recursive ^\\.\\/.*\\.js$")("./" + dataSource + ".js");
  copy = data.copy;
  domMap = data.domMap;
  mapContentToPage();
};
...
/***/ "./js/conditionalContent/content.js":
/*!******************************************!*\
  !*** ./js/conditionalContent/content.js ***!
  \******************************************/
/*! no static exports found */
...
var conditionalContent = __webpack_require__(/*! ./conditionalContent/conditionalContent.js */ "./js/conditionalContent/conditionalContent.js");
...
/***/ 0:
/*!******************************************!*\
  !*** multi ./js/main.js ./scss/app.scss ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
